        ...
        if self.First_use:
            ...
            for piece in pieces:
                ...
                if piece.grid_y == self.grid_y and piece.grid_x > self.grid_x and (piece.id[5:9] != "Rook" or self.id[:5] != piece.id[:5]):
                    ...
                    no_piece_left = False
            print("Castling def2:",self.grid_x,self.grid_y,self.id,self.grid_x-2,self.grid_x+2)
    ...
    def on_touch_down(self, touch):
        ...
        for id, child in enumerate(self.children):
            ...
            if not ChessBoard.piece_pressed:
                ...
                print("Castling uitvoeren",child.id,"Rook x:",child.grid_x,"King x",grid_x,self.children[ChessBoard.piece_index].id,"Available:",ChessBoard.available_moves["castling"])
